        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="hpanel email-compose mailbox-view mg-b-15">
                <div class="data-table-area mg-tb-15">
                    <div class="container-fluid" id="divName" style="line-height: 20px">
                        <div class="row">
                            <center>
                                <asp:Label ID="lblTitle" runat="server" Font-Bold="true" Font-Underline="true" Font-Size="25px"> COMMERCIAL INVOICE</asp:Label>
                            </center>
                        </div>
                        <div class="row">
                    ...
                    <div class="panel-footer">
                        <div class="btn-group">
                            <div class="col-lg-12" style="float: right; font-size: 25px;">
                                <input type="button" onclick="printDiv('divName')" class="btn btn-info" value="Print" />
                                &nbsp;
