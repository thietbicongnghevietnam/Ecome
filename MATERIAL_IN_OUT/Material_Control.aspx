<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Material_Control.aspx.cs" Inherits="MATERIAL_IN_OUT.Material_Control" %>
    ...
    <div class="container-fluid" >
        <div class="row" style="margin-bottom: 300px">
            ...
            <div class="col-md-4 col-md-4 col-sm-4 col-xs-12">
                <div class="text-center m-b-md custom-login" style="margin-top: 50px">
                    <h3>Regestion Form Material Issue In-Out</h3>
                    <p>&nbsp;</p>
                </div>
                <div class="hpanel">
                    <div class="panel-body" style=" background:#faf2f2">
                        <div class="form-group">
                            ...
                            <span class="help-block small">Your chosen type reason to page </span>
                        </div>
                        <div class="form-group">
