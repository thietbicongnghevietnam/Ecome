...
namespace MATERIAL_IN_OUT
{
    public class PUR_Report
    {
        ...
        public PUR_Report(DataTable dt_Data, DataTable dt_Status, String str_Titles, String commentLOG, String doc_PMS, String commentLOG2)
        {
            dt = dt_Data;
            dtStatus = dt_Status;
        ...
        public static void CreatePage()
        {
            ...
            Table_Approved.Rows.LeftIndent = 120;
            ...
            row_.Cells[10].AddParagraph("Out SAP ");
            row_.Cells[10].Format.Font.Bold = true;
            row_.Cells[10].VerticalAlignment = VerticalAlignment.Center;
            ...
            row_.Cells[10].AddParagraph("GM Approved");
            row_.Cells[10].VerticalAlignment = VerticalAlignment.Center;
            //Create Row2
            row_ = Table_Approved.AddRow();
            row_.HeadingFormat = true;
            ...
            row_.Cells[9].VerticalAlignment = VerticalAlignment.Center;
            row_.Cells[10].AddParagraph(dtStatus.Rows[0]["Status_Approved_OutSAP"].ToString());
            row_.Cells[10].VerticalAlignment = VerticalAlignment.Center;
            //Create Row3
            //Create Row3
            row_ = Table_Approved.AddRow();
            ...
            row_.Cells[9].VerticalAlignment = VerticalAlignment.Center;
            row_.Cells[10].AddParagraph(dtStatus.Rows[0]["Name_Approved_OutSAP"].ToString());
            row_.Cells[10].VerticalAlignment = VerticalAlignment.Center;
            ...
            row_.Cells[9].VerticalAlignment = VerticalAlignment.Center;
            row_.Cells[10].AddParagraph(dtStatus.Rows[0]["Date_Approved_OutSAP"].ToString());
            row_.Cells[10].VerticalAlignment = VerticalAlignment.Center;
