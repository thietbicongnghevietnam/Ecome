     ...
     <div class="card-header">
         ...
         <div class="col-sm-12">
             <div style="float: left; padding-right: 10px;">
              ...
              <div style="float: left; padding-right: 10px;">
                 RequestNO: <input type="text" id="filterRequestNo" runat="server" placeholder="Input Request No" style="height: 34px;" />
             </div>
              <div style="float: left; padding-right: 10px;">
                Sanction: <input type="text" id="filterSanctionNo" runat="server" placeholder="Input Sanction No" style="height: 34px;" />
            </div>
...
<% foreach (System.Data.DataRow rows in dt.Rows) { %>
    ...
    <tr>
        ...
        <td><%= rows["NameSacntion"].ToString() %></td>
        ...
        <td>
            ...
            <a href="#" class="btn btn-info btn-sm" title="Out201_98" onclick="openEditModal3('<%= rows["RequestNo"].ToString() %>','<%= rows["TypeForm"].ToString() %>')">Out201_98</a>
            <a href="#" class="btn btn-info btn-sm" title="Tranfer_G98" onclick="openEditModal4('<%= rows["RequestNo"].ToString() %>','<%= rows["TypeForm"].ToString() %>')">Tranfer_G99</a>
            <a href="#" class="btn btn-info btn-sm" title="Out Scrap" onclick="openEditModal5('<%= rows["RequestNo"].ToString() %>','<%= rows["TypeForm"].ToString() %>')">Out Scrap</a>
...
<script type="text/javascript">  
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    html += "<td>" + data[i].NameSacntion + "</td>";
                    html += "</tr>";
                }
    ...
    function openEditModal3(RequestNo, TypeForm) {
        $("#RequestNoid").val(RequestNo);
        $("#TypeFormid").val(TypeForm);
        $('#myModal3').modal('show');
    }
    function openEditModal4(RequestNo, TypeForm) {
        $("#RequestNo4").val(RequestNo);
        $("#TypeForm4").val(TypeForm);
        $('#myModal4').modal('show');
    }
    function openEditModal5(RequestNo, TypeForm) {
